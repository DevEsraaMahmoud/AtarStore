        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <ul class="nav prod-cat">
                    ...
                    <li>
                        <a href="products1.php?category_id=<?php echo $category->category_id; ?>"><i class="fa fa-angle-right"></i> <?php echo $category->name; ?></a>
                    </li>
            ...
            <div class="col-md-4">
                ...
                <section class="panel">
                    <div class="pro-img-box">
                        ...
                        <a class="adtocart" href="$product.php?id=<?php echo $product->id; ?>" >
